...
> 2023년 12월 우테코 식당에서 진행되는 이벤트를 위한 프로젝트

2023년 12월 한달간 우테코 식당에서 진행되는 크리스마스 프로모션을 진행하는데 사용될 프로그램입니다.
...
```
git clone https://github.com/shin5774/java-christmas-6-shin5774
```
...
1. 입력
    - 사용자가 12월중 우테코 식당에 방문할 에정일 (1~31일)
    - 사용자가 식당에서 주문할 메뉴와 개수 (전체 개수 합 20개 제한)
2. 출력
    - 사용자가 받을수 있는 최대한의 혜택
        - 증정 메뉴
        - 혜택 내역
